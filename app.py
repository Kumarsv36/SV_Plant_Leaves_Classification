...
PREDICTED_LABELS = ["Healthy","Powdery","Rust"]  # Edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/e6877761-48f9-48d0-9016-d7620f3630fc'  #Edit 2-- get endpoint URL from navigator by deploying your onnx model
...
st.title("Welcome to Plant Leaf Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Plant Leaf Image Classifier")#change according to your project   #Edit 3
...
with tab2:
  ...
  st.link_button("My Github Repository", "https://github.com/Kumarsv36/SV_Plant_Leaves_Classification") #Edit 4
  ...
  pdf_url = "https://raw.githubusercontent.com/Kumarsv36/SV_Plant_Leaves_Classification/main/Plant_Leaf_Disease_Classification_Report.pdf"
